...
<head>
    ...
    <title>FIT-GO | Verifying OTP</title>
    ...
    <script>
        ...
        function countdown()
        {
            ...
            if(countvalue == 0)
            {
                document.getElementById("timer").innerHTML = '<form method="post" action="reset_password.php"> <input style="padding:5px ; background-color:blue; color:white; cursor:pointer; border-radius:4px; border:none; " type="submit" name="resend"  value="Resend the code"></form>';
...
<body>
    <div class="container">
        ...
        <p >We sent the otp code to your moblie number to <span>reset your account</span>.</p>
        <?php
            session_start();
            ...
            if(isset($_SESSION["phone"]))
            {
                ...
                echo "<div class='info'>Please enter the 4-digit otp code sent to <b>" . $_SESSION["phone"] ."</b> to activate your account." ;
